...
def plotting_plot(
    ...
    ax2.bar(x_bar + WIDTH/2, [bar2[0], 0], WIDTH, color='lightcoral', label='36 degree no s-bees')
    ax2.bar(x_bar - WIDTH/2, [0, bar1[1]], WIDTH, color='blue', label='26 degree with s-bees')
    ax2.bar(x_bar + WIDTH/2, [0, bar2[1]], WIDTH, color='red', label='36 degree no s-bees')
    ...
    ax2.text(0.8125, 20, 'n=13', fontdict={'fontsize': 16})
